...
run_command docker build -t breizhmulator2 -f ./src/Dockerfile.build ./src
...
run_command docker run --rm -d --name breizhmulator2 breizhmulator2:latest
...
run_command docker cp breizhmulator2:/app/vm ./files/
run_command docker cp breizhmulator2:/app/client.py ./files/
run_command cd ./files/ && zip Breizhmulator-2.zip vm client.py && cd ..
run_command rm ./files/vm ./files/client.py
...
# Arrêt du conteneur
run_command docker stop breizhmulator2
...
run_command docker rmi breizhmulator2
